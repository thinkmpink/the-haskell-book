...
main = do
  ...
  putStr "thriceLifted' lms:   "
  print (thriceLifted' lms)
  putStr "lifted 4x elms:      "
  print $ (fmap . fmap . fmap . fmap) replaceWithP elms
  putStr "lifted 3x elms:      "
  print $ (fmap . fmap . fmap) replaceWithP elms
